...
pub(crate) const UNCONFIGURED_DEPENDENCIES: &[&str] =
...
impl ReadinessPort for DaemonRuntime {
...
impl ProviderPort for DaemonRuntime {
...
impl ToolPort for DaemonRuntime {
...
impl AdminPort for DaemonRuntime {
    fn dispatch(
        &self,
        _method: String,
...
impl WatchAuthPort for DaemonRuntime {
    fn authenticate(
        &self,
...
impl WatchResultPort for DaemonRuntime {
    fn handle(
        &self,
        _node_id: String,
        _result: Value,
...
impl WebhookPort for DaemonRuntime {
    fn invoke(
        &self,
        _route_id: String,
        _action: Value,
...
impl AuditPort for DaemonRuntime {
...
mod tests {
    ...
    use super::{DaemonRuntime, UNCONFIGURED_DEPENDENCIES};
